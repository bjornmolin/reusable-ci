...
main() {
  ...
  pr_policy=$(printf '{"commitlint":%s,"licenselint":%s,"dependencyreview":%s,"sastopengrep":%s,"megalint":%s,"publiccodelint":%s,"devbasecheck":%s,"swiftformat":%s,"swiftlint":%s,"swift":%s,"clippy":%s,"rustfmt":%s,"cargoaudit":%s,"rust":%s}' \
