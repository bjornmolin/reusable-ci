...
@test "rust is true when clippy is true" {
  set_all_linters_disabled
  export LINTER_CLIPPY="true"
...
@test "rust is true when rustfmt is true" {
  set_all_linters_disabled
  export LINTER_RUSTFMT="true"
...
@test "rust is true when cargoaudit is true" {
  set_all_linters_disabled
  export LINTER_CARGOAUDIT="true"
...
@test "rust is false when all rust linters are false" {
  set_all_linters_disabled
  ...
  run get_github_output "pr-policy-json"
  assert_output --partial '"rust":false'
}
...
@test "all linters disabled produces all false in policy" {
  ...
  run get_github_output "pr-policy-json"
  assert_output '{"commitlint":false,"licenselint":false,"dependencyreview":false,"sastopengrep":false,"megalint":false,"publiccodelint":false,"devbasecheck":false,"swiftformat":false,"swiftlint":false,"swift":false,"clippy":false,"rustfmt":false,"cargoaudit":false,"rust":false}'
}
